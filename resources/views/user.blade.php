                    ...
                    <div class="px-4 sm:px-6 lg:px-8">
                        <div class="sm:flex sm:items-center">
                            ...
                            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                                <a href="{{route('user.create')}}" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Tambah user</a>
                            </div>
                        </div>
                                        ...
                                        <table class="min-w-full divide-y divide-gray-300">
                                            ...
                                            <tbody class="divide-y divide-gray-200 bg-white">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{$item->role_id}}</td>
                                                ...
                                                @empty
                                                <tr class="relative">
                                                    <td colspan="4" class="whitespace-nowrap py-4 pl-4 pr-3 text-lg font-medium text-red-900 sm:pl-6">Data Tidak Ditemukan</td>
                                                </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
